...
namespace WebApiCaseStudy.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public AuthenticateController()
        {
            ...
            {
                new UserModel() { UserId = 1, UserName = "Swetha", Password = "Swee123", Role = "Admin" },
                new UserModel() { UserId = 2, UserName = "Lahari", Password = "Lahari123", Role = "User" }
            };
        }
