...
namespace CaseStudy2.Controllers
{
    ...
    public class ProductApiController : ControllerBase
    {
        ...
        {
            /*obj = _productsService.Create(obj);
            var r = new HttpResponseMessage CreateResponse<Product>(this System.Net.Http.HttpRequestMessage request, T value);
            var response = Request.CreateResponse<Product>(HttpStatusCode.Created, obj);

            string uri = Url.Link("DefaultApi", new { id = obj.ProductId });
